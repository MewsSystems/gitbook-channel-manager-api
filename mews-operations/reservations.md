...
| `loyaltyInfo` | [`LoyaltyInfo`](#loyalty-info) object | optional | Loyalty information of the customer. Processed only within main customer or [`Availability block`](../channel-manager-operations/availabilityBlock.md#availability-block) booker. |
