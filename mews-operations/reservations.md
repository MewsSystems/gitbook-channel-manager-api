...
| `loyaltyInfo` | [`LoyaltyInfo`](#loyaltyInfo) object | optional | Loyalty information of the customer. Processed only within main customer or [`Availability block`](../channel-manager-operations/reservations.md#availabilityBlock) booker. |
